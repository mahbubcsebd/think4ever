        ...
        <div className="space-y-14">
          ...
          <div className="space-y-4 max-w-4xl">
            <p className="text-gray-500 text-[15px] leading-[1.8]">
              ...
              <Link href="https://www.think4ever.com" className="text-[#07A7E1] font-semibold hover:underline underline-offset-2 transition-colors">www.think4ever.com</Link>{' '}
          ...
          <section>
            ...
            <p className="text-gray-500 text-[14.5px] leading-[1.8]">
              ...
              <a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#07A7E1] font-semibold hover:underline underline-offset-2 transition-colors">www.allaboutcookies.org</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-500 text-[14.5px] leading-[1.8]">
              To exercise any of these rights, please contact us using the details provided in <strong className="text-[#1f2937]">Section 11</strong>. We will respond to your request within <strong className="text-[#07A7E1]">30 days</strong>.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-[#fafbfc] rounded-xl p-6 sm:p-8 border border-gray-100 space-y-2.5">
              ...
              <p className="text-[14.5px] text-gray-500">
                Website:{' '}
                <a href="https://www.think4ever.com" className="text-[#07A7E1] font-semibold hover:underline underline-offset-2 transition-colors">www.think4ever.com</a>
              </p>
              <p className="text-[14.5px] text-gray-500">
                Email:{' '}
                <a href="mailto:privacy@think4ever.com" className="text-[#07A7E1] font-semibold hover:underline underline-offset-2 transition-colors">privacy@think4ever.com</a>
              </p>
            </div>
