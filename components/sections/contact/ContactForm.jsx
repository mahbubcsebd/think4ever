    ...
    <div className="flex-1 bg-white border border-gray-100 rounded-lg p-6 sm:p-10 shadow-sm">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Button
          ...
          className="w-full h-12 bg-gradient-to-r from-[#07A7E1] to-[#093cad] hover:from-[#068cb0] hover:to-[#072f85] text-white rounded-md font-bold font-sans text-[16px] shadow-lg shadow-blue-500/20 transition-all active:scale-[0.98]"
        >
