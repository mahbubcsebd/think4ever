    ...
    <section className="max-w-5xl mx-auto px-4 pb-20 sm:pb-32">
      <div className="bg-[#fbfcfe] border border-gray-100 rounded-md p-10 sm:p-14 text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 pt-2">
            <Button asChild className="h-11 px-8 bg-white border border-[#e2e8f0] hover:bg-gray-50 text-gray-800 rounded-md font-bold text-[13px] shadow-sm active:scale-[0.98] transition-all">
              <Link href="/contact-us" className="flex items-center gap-2">
                <Mail size={16} />
                Contact Us
              </Link>
            </Button>
            <Button asChild className="h-11 px-8 bg-gradient-to-r from-[#07A7E1] to-[#093cad] hover:opacity-90 text-white rounded-md font-bold text-[13px] shadow-lg shadow-blue-500/15 active:scale-[0.98] transition-all border-none">
