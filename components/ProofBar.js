    ...
    <div className={`relative z-30 w-full flex justify-center ${className}`}>
      <div className="w-full max-w-5xl">
        <motion.div
          ...
          className="bg-white/95 backdrop-blur-2xl border border-zinc-200/80 shadow-2xl shadow-zinc-200/50 rounded-[20px] md:rounded-[24px] flex flex-col sm:flex-row divide-y sm:divide-y-0 sm:divide-x divide-zinc-200 overflow-hidden"
        >
